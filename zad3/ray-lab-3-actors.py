...
class MethodStateCounter:
    ...
    def invoke(self, name):
        ...
        #add computed value
        self.computed_values[name].append(number)
        return number
    ...
    def get_invoker_computed_values(self,name):
        # return the computed values by the named invoker
